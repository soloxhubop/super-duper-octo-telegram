...
task.spawn(function()
    ...
    local function startDesync()
        ...
        animConnection = hum and hum.AnimationPlayed:Connect(function(t) t:Stop() end)
    end
    ...
    dStroke.Color = Color3.fromRGB(30, 90, 200)
    ...
    -- Title bar
    local dTitleBar = Instance.new("Frame", dFrame)
    dTitleBar.Size = UDim2.new(1, 0, 0, 40)
    dTitleBar.BackgroundTransparency = 1
    MakeDraggable(dTitleBar, dFrame, "DesyncPanel")

    local dTitle = Instance.new("TextLabel", dTitleBar)
    dTitle.Size = UDim2.new(1, -80, 1, 0)
    dTitle.Position = UDim2.new(0, 10, 0, 0)
    dTitle.BackgroundTransparency = 1
    dTitle.Text = "MELOSKA DESYNC"
    dTitle.TextColor3 = Color3.fromRGB(60, 140, 255)
    dTitle.Font = Enum.Font.GothamBold
    dTitle.TextSize = 16
    dTitle.TextXAlignment = Enum.TextXAlignment.Left

    local minBtn = Instance.new("TextButton", dTitleBar)
    minBtn.Size = UDim2.new(0, 30, 0, 30)
    minBtn.Position = UDim2.new(1, -70, 0.5, -15)
    minBtn.Text = "-"
    minBtn.BackgroundColor3 = Color3.fromRGB(18, 26, 52)
    minBtn.TextColor3 = Color3.fromRGB(60, 140, 255)
    minBtn.Font = Enum.Font.GothamBold
    minBtn.BorderSizePixel = 0
    Instance.new("UICorner", minBtn).CornerRadius = UDim.new(0, 8)

    local closeBtn = Instance.new("TextButton", dTitleBar)
    closeBtn.Size = UDim2.new(0, 30, 0, 30)
    closeBtn.Position = UDim2.new(1, -35, 0.5, -15)
    closeBtn.Text = "X"
    closeBtn.BackgroundColor3 = Color3.fromRGB(18, 26, 52)
    closeBtn.TextColor3 = Color3.fromRGB(60, 140, 255)
    closeBtn.Font = Enum.Font.GothamBold
    ...
    dContent.Size = UDim2.new(1, 0, 1, -40)
    dContent.Position = UDim2.new(0, 0, 0, 40)
    dContent.BackgroundTransparency = 1

    -- Status frame
    local statusFrame = Instance.new("Frame", dContent)
    statusFrame.Size = UDim2.new(1, -20, 0, 40)
    statusFrame.Position = UDim2.new(0, 10, 0, 5)
    statusFrame.BackgroundColor3 = Color3.fromRGB(10, 14, 28)
    ...
    statusLabel.Text = "Desync inactive"
    ...
    -- Toggle frame
    local toggleFrame = Instance.new("Frame", dContent)
    toggleFrame.Size = UDim2.new(1, -20, 0, 55)
    toggleFrame.Position = UDim2.new(0, 10, 0, 52)
    toggleFrame.BackgroundColor3 = Color3.fromRGB(10, 14, 28)
    toggleFrame.BorderSizePixel = 0
    Instance.new("UICorner", toggleFrame).CornerRadius = UDim.new(0, 10)

    local toggleTitle = Instance.new("TextLabel", toggleFrame)
    toggleTitle.Size = UDim2.new(0.6, 0, 0, 25)
    toggleTitle.Position = UDim2.new(0, 15, 0, 8)
    toggleTitle.BackgroundTransparency = 1
    toggleTitle.Text = "DESYNC"
    toggleTitle.TextColor3 = Color3.fromRGB(60, 140, 255)
    ...
    toggleDesc.Text = "Freeze animation tracks"
    toggleDesc.TextColor3 = Color3.fromRGB(130, 130, 140)
    ...
    local function updateVisuals()
        if desyncToggled then
            TweenService:Create(toggleButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(60, 140, 255)}):Play()
            toggleCircle:TweenPosition(UDim2.new(1, -22, 0.5, -10), "Out", "Quad", 0.2, true)
            TweenService:Create(statusDot, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(0, 200, 255)}):Play()
            statusLabel.Text = "Hook active — packets intercepted"
        else
            ...
            TweenService:Create(statusDot, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(255, 50, 50)}):Play()
            statusLabel.Text = "Desync inactive"
        end
    end
    ...
    minBtn.MouseButton1Click:Connect(function()
        dContent.Visible = not dContent.Visible
        local newH = dContent.Visible and 145 or 45
        TweenService:Create(dFrame, TweenInfo.new(0.25), {Size = UDim2.new(0, 280, 0, newH)}):Play()
    end)

    closeBtn.MouseButton1Click:Connect(function()
        desyncGui.Enabled = false
        Config.ShowDesyncPanel = false
        SaveConfig()
    end)
